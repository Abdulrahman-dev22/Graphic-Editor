...
public class GraphicsEditor {
    ...
    private static JPanel createShapesPanel() {
        ...
        JTextField scaleTextField = new JTextField(3);
...
// ================== This part for transformation ===============================
        ...
        scaleButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int y = Integer.parseInt(yTextField.getText());
                int size = Integer.parseInt(sizeTextField.getText());
                 int scaleFactor = Integer.parseInt(scaleTextField.getText());

                boolean fill = fillButton.isSelected();

                scaleShape(selectedShape, scaleFactor, x, y, size, fill);
            }
        });
   ...
   public static void scaleShape(String shape,double scaleFactor,int x,int y,int size,boolean fill) {
    ...
    private static void rotateShape(String shape, int x, int y, int size, boolean fill) {
        ...
        if (shape.equals("Rectangle")) {
            if (fill) g.fillRect(x + size, y, size, size); // Fill rectangle
            else g.drawRect(x + size, y, size, size);
        } else if (shape.equals("Circle")) {
            if (fill) g.fillOval(x + size, y, size, size); // Fill circle
            else g.drawOval(x + size, y, size, size);
